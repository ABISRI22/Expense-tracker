...
export const navbarStyles = {
  ...
  userAvatar: "relative w-9 h-9 flex items-center justify-center rounded-full bg-gradient-to-br from-teal-600 to-cyan-500 text-white font-bold text-lg",
...
// Example in dummyStyles.js
submitButton: (colorClass) =>
  `px-4 py-2 rounded-md font-medium ${colorClass.bg} ${colorClass.text} hover:opacity-90 transition`,
...
export const GAUDE_COLORS = {
  Income: "#8884d8",
  Spent: "#82ca9d",
  Savings: "#ffc658",
};

export const INCOME_COLORS = ["#00C49F", "#0088FE"];
