...
import { X,ArrowDown, ArrowUp, HelpCircle, Home, User,Menu ,LogOut} from 'lucide-react';
...
const Sidebar = ({ user, setIsCollapsed, isCollapsed }) => { 
  ...
  return (
    <>
      ...
      sidebarStyles.footerContainer.base,
        isCollapsed && "justify-center" // center when collapsed
        )}
         >
