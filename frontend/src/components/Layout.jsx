...
import { ArrowUp, ArrowDown, Car,Info, CreditCard, DollarSign, Gift, Home, PiggyBank, ShoppingCart, TrendingUp, Utensils, Zap, Activity, Clock, RefreshCcw, ChevronUp, ChevronDown, PieChart } from 'lucide-react';
...
const Layout = ({ onLogout, user }) => {
  ...
  //to fetch transcation from backend
const fetchTransactions = async () => {
  try {
    setLoading(true);

    const token = localStorage.getItem("token"); // ✅ declare first
    console.log("TOKEN:", token); // ✅ now safe
  ...
  //to add transcation either expense or income
      ...
      <div className={styles.layout.mainContainer(sidebarCollapsed)}>
        ...
        <div className={styles.statCards.grid}>
          ...
          <div className={styles.statCards.card}>
            <div className={styles.statCards.cardHeader}>
              <div>
                <p className={styles.statCards.cardTitle}>Montly Income</p>
                <p className={styles.statCards.cardValue}>
                  ₹
          ...
          <div className={styles.statCards.card}>
            <div className={styles.statCards.cardHeader}>
              <div>
                <p className={styles.statCards.cardTitle}>Montly Expense</p>
                <p className={styles.statCards.cardValue}>
                  ₹
        ...
        <div className={styles.grid.main}>
            ...
            <div className={styles.cards.base}>
              <div className={styles.cards.header}>
                <h3 className={styles.cards.title}>
                  <TrendingUp className="w-5 h-6 text-teal-500" />
                  Financial Overview
          ...
          <div className={styles.grid.rightColumn}>
            <div className={styles.cards.base}>
              <div className={styles.transactions.cardTitle}>
                          ...
                          <DollarSign className={styles.transactions.icon}/>
                           ...
                           <div className={styles.transactions.details}>
                             ...
                             <p className={styles.transactions.meta}>
                              ...
                              <span className="ml-2 capitalizer">
                                {category}
                              </span>
                              </p>
                           </div>
              ...
              <div className={styles.cards.base}>
                ...
                <div className={styles.categories.list}>
                  {topCategories.map(([category,amount])=>(
                    <div className={styles.categories.categoryItem} key={category}>
