  ...
  {categories.map(cat => (
    <option value={cat} key={cat}>
      {cat}
            ...
            <button type="submit" className={modalStyles.submitButton("w-full text-white py-3 rounded-lg font-medium mt-4 shadow-md hover:shadow-lg transition-all bg-blue-500 hover:bg-blue-600")}>
             {buttonText}
             </button>
