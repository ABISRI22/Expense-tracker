...
import { Eye, EyeOff, TableRowsSplit, User, X,Lock } from 'lucide-react';
...
//input  change handlers
  ...
  const closedPasswordModal = useCallback(() => {
    if(!loading){
        setShowPasswordModal(false);
        setPasswordData({current: "",new:"",confirm : "" });
        setPasswordErrors({});
    ...
    <div className={profileStyles.container}>
      ...
      <div className={profileStyles.mainContainer}>
        <div className={profileStyles.header}>
            ...
            <h1 className={profileStyles.userEmail}>
                {user.name || "Loading..."}
            </h1>
      ...
      <Modal
        ...
        onRequestClose={closedPasswordModal}
